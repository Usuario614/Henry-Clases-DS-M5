...
--
-- Dumping events for database 'henry_m3'
--

--
-- Dumping routines for database 'henry_m3'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `UC_Words`( str VARCHAR(255) ) RETURNS varchar(255) CHARSET utf8mb3
BEGIN  
  DECLARE c CHAR(1);  
...
/*!50003 DROP PROCEDURE IF EXISTS `Llenar_dimension_calendario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
